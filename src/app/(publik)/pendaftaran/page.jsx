...
export const metadata = {
	title: 'Pendaftaran Siswa Baru (PPDB) - MTs Al-Jihad Medan',
	description: 'Informasi lengkap mengenai alur, jadwal, dan syarat pendaftaran peserta didik baru (PPDB) di MTs Al-Jihad Medan untuk tahun ajaran mendatang.',
};

export default function PendaftaranInfoPage() {
	return (
		<main className="container mx-auto px-6 py-12">
			...
			<section className="text-center">
				...
				<div className="flex flex-col sm:flex-row justify-center items-center gap-4">
					<Link href="/pendaftaran/form" className="w-full sm:w-auto bg-amber-500 hover:bg-amber-600 text-white font-bold py-3 px-8 rounded-full text-lg transition duration-300">
						Formulir Pendaftaran Online
					</Link>

					<Link href="/kontak" className="w-full sm:w-auto text-blue-800 font-semibold py-3 px-8 rounded-full border-2 border-blue-800 hover:bg-blue-800 hover:text-white transition duration-300">
						Hubungi Panitia
					</Link>
				</div>
			</section>
