			...
			{data && (
				<>
					...
					<section className="mb-16">
						<h2 className="text-3xl font-bold text-blue-800/94 mb-8 text-center">Program Unggulan</h2>
					...
					<section>
						<h2 className="text-3xl font-bold text-blue-800/94 mb-8 text-center">Ekstrakurikuler</h2>
						<div className="flex flex-wrap justify-center gap-4">
							{data.ekstrakurikuler.split(',').map((item, index) => (
								<div key={index} className="bg-white py-2 px-4 rounded-full shadow text-center font-semibold text-blue-800/94">
									{item.trim()}
								</div>
							))}
						</div>
