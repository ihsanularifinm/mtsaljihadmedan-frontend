		...
		<div className="container mx-auto p-6">
			...
			<div className="bg-white p-8 rounded-lg shadow-lg">
				<form onSubmit={handleSubmit}>
					<div className="mb-6">
						<label htmlFor="sejarah_singkat" className="block text-xl font-medium text-gray-700 mb-2">
							Sejarah Singkat (untuk Halaman Utama)
						</label>
						<textarea id="sejarah_singkat" name="sejarah_singkat" rows="4" className="w-full px-3 py-2 border border-gray-300 rounded-md" value={formData.sejarah_singkat} onChange={handleChange}></textarea>
					</div>

					<div className="mb-6">
						<label htmlFor="sejarah" className="block text-xl font-medium text-gray-700 mb-2">
							Sejarah Lengkap (untuk Halaman Profil)
						</label>
						<textarea id="sejarah" name="sejarah" rows="8" className="w-full px-3 py-2 border border-gray-300 rounded-md" value={formData.sejarah} onChange={handleChange}></textarea>
					</div>
