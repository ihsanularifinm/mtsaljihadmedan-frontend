...
function Kontak() {
	...
	return (
		<main className="container mx-auto px-6 py-12">
			...
			<h1 className="text-4xl font-bold text-center text-primary mb-12">Hubungi Kami</h1>

			<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 bg-white p-8 rounded-lg shadow-lg">
				<div className="space-y-6">
					<div>
						<h2 className="text-2xl font-bold text-accent mb-4">Informasi Kontak</h2>
					...
					<div>
						<h2 className="text-2xl font-bold text-accent mb-4">Lokasi Kami</h2>
				...
				<div>
					<h2 className="text-2xl font-bold text-accent mb-4">Kirimkan Pesan</h2>
