	...
	return (
		<section className="text-white text-center py-20 px-6" style={heroStyle}>
			<div className="container mx-auto">
				...
				<Link to="/pendaftaran" className="inline-block bg-amber-500 font-bold py-3 px-8 rounded-full text-lg text-white hover:bg-amber-600 transition-colors duration-300">
